"""Code from review_object_detection_metrics codebase: src.bounding_box
...
from networks.metrics.rafaelpadilla.enumerators import CoordinatesType, BBType, BBFormat
from networks.metrics.rafaelpadilla.general_utils import convert_to_absolute_values, \
...
class BoundingBox:
    ...
    def __init__(self,
                 ...
                 img_size=None,
                 img_mpp: Optional[Tuple[float, float]] = None,
        ...
        ----------
            ...
            img_mpp: The MPP of the image that the bounding box is contained in.
